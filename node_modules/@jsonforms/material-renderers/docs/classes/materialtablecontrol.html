...
<span class="hljs-keyword">declare</span> context: React.ContextType&lt;<span class="hljs-keyword">typeof</span> MyContext&gt;
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited">
					...
					<div class="tsd-signature tsd-kind-icon">props<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Readonly</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">ArrayLayoutProps</span><span class="tsd-signature-symbol"> &amp; </span><a href="../interfaces/withdeletedialogsupport.html" class="tsd-signature-type">WithDeleteDialogSupport</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> &amp; </span><span class="tsd-signature-type">Readonly</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-symbol">{ </span>children<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">ReactNode</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">&gt;</span></div>
					<aside class="tsd-sources">
				...
				<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in packages/material/src/complex/MaterialTableControl.tsx:380</li>
								</ul>
							</aside>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								...
								<ul>
									<li>Defined in packages/material/src/complex/MaterialTableControl.tsx:381</li>
								</ul>
							</aside>
