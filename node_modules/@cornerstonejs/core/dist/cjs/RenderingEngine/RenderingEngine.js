...
const viewportTypeToViewportClass_1 = __importDefault(require("./helpers/viewportTypeToViewportClass"));
...
class RenderingEngine {
    ...
    _resizeVTKViewports(vtkDrivenViewports, keepCamera = true, immediate = true) {
        vtkDrivenViewports.forEach((vp) => {
            (0, getOrCreateCanvas_1.default)(vp.element);
        });
    ...
    addCustomViewport(viewportInputEntry) {
        ...
        const ViewportType = viewportTypeToViewportClass_1.default[type];
