    ...
    constructor(toolProps = {}, defaultToolProps = {
        ...
        this._calculateCachedStats = (annotation, viewport, renderingEngine, enabledElement) => {
            ...
            for (let i = 0; i < targetIds.length; i++) {
                ...
                const { scale, areaUnits } = (0, getCalibratedUnits_1.getCalibratedLengthUnitsAndScale)(image, () => {
                ...
                const pointsInShape = (0, pointInShapeCallback_1.default)(imageData, (pointLPS, pointIJK) => {
                    let result = true;
                ...
                cachedStats[targetId] = {
                    ...
                    area,
                    perimeter: (0, calculatePerimeter_1.default)(canvasCoordinates, closed),
...
function defaultGetTextLines(data, targetId) {
    ...
    if (perimeter) {
        textLines.push(`Perimeter: ${(0, utilities_1.roundNumber)(perimeter)} ${modalityUnit}`);
    }
    return textLines;
}
